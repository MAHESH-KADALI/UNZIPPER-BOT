<div align="center">
  ...
  <h1><a href="https://github.com/maheshsirop/UNZIPPER-BOT" target="_blank" rel="noreferrer"><img src="https://graph.org/file/0f20570db175553686f09.jpg" alt="unzip-bot" width="40" height="40"/></a> Unarchiver Bot • Changelog</h1>
...
- Finally fixed [#133](https://github.com/maheshsirop/UNZIPPER-BOT/issues/133)
...
- Aded VIP methods in DB + implementation of no-restrictions for VIP ([#205](https://github.com/maheshsirop/UNZIPPER-BOT/issues/205))
...
- All strings are in `bot_data.py`, hope this should ease [#179](https://github.com/maheshsirop/UNZIPPER-BOT/issues/179)
...
- Attempt to implement [#137](https://github.com/maheshsirop/UNZIPPER-BOT/issues/137)
- New boot sequence
...
- Uploading videos as media is fixed ! [#133](https://github.com/maheshsirop/UNZIPPER-BOT/issues/133)
...
- [#33](https://github.com/maheshsirop/UNZIPPER-BOT/issues/33) is gone (no longer useless alerts)
- ETA is now correct
...
- Added ZIPX support
- Added a Refresh button on /stats ([#143](https://github.com/maheshsirop/UNZIPPER-BOT/issues/143))
...
- Added requests
- Added development followup ([#38](https://github.com/maheshsirop/UNZIPPER-BOT/issues/38))
...
- Fixed crashes
- Made `/stats` working for non owner, as requested in [#34](https://github.com/maheshsirop/UNZIPPER-BOT/issues/34)
...
- Added workaround for [#26](https://github.com/maheshsirop/UNZIPPER-BOT/issues/26)
...
- Fixed major bug : REPLY_MARKUP_TOO_LONG ([#2](https://github.com/maheshsirop/UNZIPPER-B/issues/2))
- Try to close session (to fix [#4](https://github.com/maheshsirop/UNZIPPER-BOT/issues/4))
...
- Consider this as the [original work of Nexa](https://github.com/maheshsirop/UNZIPPER-BOT#license--copyright-%EF%B8%8F)
