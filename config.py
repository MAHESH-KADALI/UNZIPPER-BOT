...
class Config:
    ...
    DOWNLOAD_LOCATION = f"{os.path.dirname(_file_)}/Downloaded"
    THUMB_LOCATION = f"{os.path.dirname(_file_)}/Thumbnails"
    TG_MAX_SIZE = 2097152000
    MAX_MESSAGE_LENGTH = 4096
    # Default chunk size (0.005 MB → 1024*6) Increase if you need faster downloads
    CHUNK_SIZE = 1024 * 1024 * 10  # 10 MB
    BOT_THUMB = f"{os.path.dirname(_file_)}/bot_thumb.jpg"
